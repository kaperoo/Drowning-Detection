...
for directory in folder:
    for video_filename in os.listdir(os.path.join(directory)):
        ...
        while True:  
            ...
            # convert blank to tensor
            blank = blank.transpose(2, 0, 1)
            blank = torch.tensor(blank).float()
            ...
            # for i in frame_buffer:
                ...
                keypoints_tensor = keypoints_tensor.permute(1, 2, 0, 3, 4)
            ...
            conf = torch.max(softmax, dim=1).values
