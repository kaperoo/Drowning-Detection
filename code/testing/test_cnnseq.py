# PURPOSE: Predicts the class of a given video using the CNNSEQ model
    ...
    if file.endswith(".pt"):
        ...
        for i in range(0,len(test_data)):
            ...
            if len(frame_buffer) > 5:
                ...
                # get the most frequent class in the sequence
        ...
        # calculate the accuracy for the video
        ...
        # check if the prediction for the whole video is correct
