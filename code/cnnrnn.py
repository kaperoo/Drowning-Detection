# Purpose: CNN-RNN model for keypoint classification
...
class CNNModel(nn.Module):
    def __init__(self):
        ...
        self.hidden_size = 63# 114 # 63
        self.num_layers = 3#4 # 3
        self.cnn = nn.Sequential(
            nn.Conv2d(17, 86, kernel_size=(3, 3), padding=(1, 1)), # 17, 86, 218, 227 / 17, 187, 176, 66
            nn.MaxPool2d(kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.ReLU(),
            nn.Conv2d(86, 218, kernel_size=(3, 3), padding=(1, 1)),
            nn.MaxPool2d(kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.ReLU(),
            nn.Conv2d(218, 227, kernel_size=(3, 3), padding=(1, 1)),
            nn.MaxPool2d(kernel_size=(3, 3), stride=(1, 1), padding=(1, 1)),
            nn.ReLU(),
        )
        # Add an GRU layer
        self.lstm = nn.GRU(input_size=227 * 3, hidden_size=self.hidden_size, num_layers=self.num_layers, batch_first=True)
...
if __name__ == "__main__":
    ...
    with open('model_state_rnn.pt', 'wb') as f: 
